...
<div class="content">
    <form action="{{ route('admin.post.searchItems') }}" method="GET">
        <div class="form-group form-group-feedback form-group-feedback-right search-box">
            <input type="text" class="form-control form-control-lg search-input" placeholder="Procurar produto pelo nome ..."
                name="query">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Add Novo Produto</span></h5>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="uploader">
                                ...
                                <span class="help-text text-muted">Resolução: 486x355</span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
...
<div id="addBulkItemModal" class="modal fade mt-5" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">CSV Bulk Upload dos produtos</span></h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
