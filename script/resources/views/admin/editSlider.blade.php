                    ...
                    <form action="{{ route('admin.updateSlider') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <option value="0" @if($slider->position_id == 0) selected="selected" @endif>Principal</option>
                                <option value="1" @if($slider->position_id == 1) selected="selected" @endif>Apos 1º Loja</option>
                                <option value="2" @if($slider->position_id == 2) selected="selected" @endif>Apos 2º Loja</option>
                                <option value="3" @if($slider->position_id == 3) selected="selected" @endif>Apos 3º Loja</option>
                                <option value="4" @if($slider->position_id == 4) selected="selected" @endif>Apos 4º Loja</option>
                                <option value="5" @if($slider->position_id == 5) selected="selected" @endif>Apos 5º Loja</option>
                                <option value="6" @if($slider->position_id == 6) selected="selected" @endif>Apos 6º Loja</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <option value="1" @if($slider->size == 1) selected="selected" @endif>Muito Pequena</option>
                                <option value="2" @if($slider->size == 2) selected="selected" @endif>Pequena</option>
                                <option value="3" @if($slider->size == 3) selected="selected" @endif>Media</option>
                                <option value="4" @if($slider->size == 4) selected="selected" @endif>Grande</option>
                                <option value="5" @if($slider->size == 5) selected="selected" @endif>Muito Grande</option>
                                </select>
                            </div>
                        </div>
                        @csrf
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row" id="sortable">
                        ...
                        <div class="col-md-3 mb-2 each-slide" data-id="{{ $slide->id }}">
                            ...
                            <div class="btn-group btn-group-justified" style="width: 150px">
                                <a href="{{ route('admin.editSlide', $slide->id) }}" class="btn btn-dark rounded-0" data-popup="tooltip" title="Editar Slide" data-placement="bottom"> <i class="icon-pencil3"></i> </a>
                                <a href="{{ route('admin.deleteSlide', $slide->id) }}" class="btn btn-danger" data-popup="tooltip" title="Deletar Slide" data-placement="bottom"> <i class="icon-trash"></i> </a>
                                @if($slide->is_active)
                                <a href="{{ route('admin.disableSlide', $slide->id) }}" class="btn btn-secondary rounded-0" data-popup="tooltip" title="Desativar Slide" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                @else
                                <a href="{{ route('admin.disableSlide', $slide->id) }}" class="btn btn-warning rounded-0" data-popup="tooltip" title="Ativar Slide" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                @endif
                            </div>
                        </div>
                        @endforeach
                    ...
                    <form action="{{ route('admin.saveSlide') }}" method="POST" id="slideForm" class="mt-3 hidden" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label">Slide Nome:</label>
                            <div class="col-lg-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="uploader">
                                    ...
                                    <span class="help-text text-muted">Dimensão 384x384</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <button class="btn btn-md btn-primary" id="enterCustomURL" type="button">Digitar URL Customizada</button>
                        <div class="form-group row hidden" id="customURL">
                            <label class="col-lg-3 col-form-label">URL Customizada:</label>
                            <div class="col-lg-9">
                                <input type="url" class="form-control form-control-lg" name="customUrl" id="customUrl" placeholder="Digitar URL Customizada">
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <span class="help-text">Cuidado, todos os slides associados a esse controle deslizante também serão excluídos permanentemente. <br> Você pode usar o "<strong>DESATIVAR</strong>" para desabiltiar temporariamente.</span>
                <div class="modal-footer mt-4">
                    <a href="{{ route('admin.deleteSlider', $slider->id) }}" class="btn btn-primary">Sim</a>
