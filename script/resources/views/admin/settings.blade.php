...
@section("title") Definições -Painel
@endsection
@section('content')
<style>
    .disable-switch {
...
<div class="content">
    <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg min-payout" name="minPayout"
                                            ...
                                            placeholder="Pagamento mínimo para a loja em {{ config('settings.currencyFormat') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="seoMetaTitle"
                                            value="{{ config('settings.seoMetaTitle') }}" placeholder="Titulo Meta">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg" name="seoOgTitle"
                                            value="{{ config('settings.seoOgTitle') }}" placeholder="Grafico do Titulo Aberto">
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="tab-pane fade" id="paymentGatewaySettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        selected @endif>Sandbox (Teste)</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="otpMessage"
                                    value="{{ config('settings.otpMessage') }}" placeholder="OTP Mensagem: ">
                            </div>
                        </div>
                        <hr>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="defaultSmsRestaurantMsg"
                                    value="{{ config('settings.defaultSmsRestaurantMsg') }}" placeholder="Nova mensagem de pedido na loja">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="defaultSmsDeliveryMsg"
                                    value="{{ config('settings.defaultSmsDeliveryMsg') }}" placeholder="Nova mensagem de pedido para o Entregador">
                            </div>
                        </div>
                        <hr>
                        {{-- 
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Notificação por SMS para status do pedidos</strong></label>
                            <div class="col-lg-9">
                                <div class="checkbox checkbox-switchery mt-2">
                                    <label>
                                    <input value="true" type="checkbox" class="switchery-primary"
                    ...
                    <div class="tab-pane fade" id="emailSettings">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><strong>Servidor SMTP</strong></label>
                                ...
                                <option @if(config('settings.defaultEmailGateway') == "smtp" ) selected @endif value="smtp">SMTP</option>
                                </select>
                            </div>
                        </div>
                        <hr>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="mail_username"
                                value="{{ config('settings.mail_username') }}" placeholder="SMTP Usuario">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="mail_password"
                                value="{{ config('settings.mail_password') }}" placeholder="SMTP Senha">
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        selected="selected" @endif>Comissão do valor total do Pedido
        </option>
        <option value="DELIVERYCHARGE"
        @if(config('settings.deliveryGuyCommissionFrom')=="DELIVERYCHARGE"
        ) selected="selected" @endif>Comissão do valor da Entrega</option>
        </select>
        </div>
        </div>
        <div class="form-group row">
        ...
        <div class="col-lg-9">
                                ...
                                <option value="5" @if(config('settings.restaurantNewOrderRefreshRate') == "5") selected @endif>A cada 5 Segudos</option>
                                <option value="15" @if(config('settings.restaurantNewOrderRefreshRate') == "15") selected @endif>A cada 15 Segudos</option>
                                <option value="25" @if(config('settings.restaurantNewOrderRefreshRate') == "25") selected @endif>A cada 25 Segudos</option>
                                <option value="30" @if(config('settings.restaurantNewOrderRefreshRate') == "30") selected @endif>A cada 30 Segudos</option>
                                </select>
        ...
        <div class="tab-pane fade" id="fixUpdateIssues">
                        ...
                        @if(Request::secure())
                        <a href="{{ route('admin.fixUpdateIssues') }}" class="btn btn-lg btn-primary">Fixar Atualização</a>
                        @else
