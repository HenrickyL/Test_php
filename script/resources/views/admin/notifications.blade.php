...
@section("title") Enviar Notificação - Painel
@endsection
@section('content')
<style>
    .dropzone {
...
<div class="page-header">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4>
                <span class="font-weight-bold mr-2">Total de Usuarioss</span>
...
<div class="content">
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <h3 class="text-muted mb-3"><strong>Enviar notificação push e alerta a todos os usuários</strong></h3>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="uploader">
                                ...
                                <span class="help-text text-muted">Tamanho: 1600x1100</span>
                            </div>
                        </div>
                    </div>
                    <form action="{{ route('admin.sendNotifiaction') }}" method="POST" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Titulo:</label>
                            <div class="col-lg-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control form-control-lg" name="data[message]"
                                    placeholder="Mensagem de notificação" required>
                            </div>
                        </div>
                        <div class="form-group row">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <h3 class="text-muted mb-3"><strong>Enviar notificação push e alerta para usuários selecionados</strong></h3>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Imagem: </label>
                        <div class="col-lg-9">
                            <img class="slider-preview-image hidden"/>
                    ...
                    <form action="{{ route('admin.sendNotificationToSelectedUsers') }}" method="POST" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Selecionar Usuario:</label>
                            <div class="col-lg-9">
