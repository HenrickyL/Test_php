...
@section("title") Relatorios - Painel
@endsection
@section('content')
<style>
    .chart-container {
            ...
            <form action="{{ route('admin.viewTopItems') }}" method="GET">
                <div class="form-group row mb-0">
                    ...
                    <div class="col-lg-5">
                        ...
                        <option value="1" @if(app('request')->input('range') == '1') selected @endif class="text-capitalize">Esta semana</option>
                        <option value="2" @if(app('request')->input('range') == '2') selected @endif class="text-capitalize">Últimos 7 dias</option>
                        <option value="3" @if(app('request')->input('range') == '3') selected @endif class="text-capitalize">Este mês ({{ \Carbon\Carbon::now()->format('F')}})</option>
                        <option value="4" @if(app('request')->input('range') == '4') selected @endif class="text-capitalize">Últimos 30 dias</option>
                        <option value="5" @if(app('request')->input('range') == '5') selected @endif class="text-capitalize">Todos</option>
                        </select>
                    </div>
                    <div class="col-lg-2">
        ...
        <div class="col-xl-6">
            <div class="panel panel-flat dashboard-main-col mt-4" style="min-height: 30rem;">
                <div class="panel-heading">
                    <h4 class="panel-title pl-3 pt-3"><strong>Top 10 Itens mais vendidos </strong></h4>
                    <hr>
                </div>
