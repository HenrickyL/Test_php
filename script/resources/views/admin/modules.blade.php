                              ...
                              <td class="text-center">
                                <div class="btn-group btn-group-justified align-items-center">
                                  ...
                                  <a href="{{ route('admin.disableModule', $module->getStudlyName()) }}"
                                      class="btn btn-primary btn-labeled btn-labeled-left btn-sm enDisBtn"  data-popup="tooltip" title="Duplo Clique para desativar" data-placement="left">
                                      <b><i class="icon-checkmark3 ml-1"></i></b>
                                  Ativo
                                  </a>
                                  @else
                                  <a href="{{ route('admin.enableModule', $module->getStudlyName()) }}"
                                      class="btn btn-danger btn-labeled btn-labeled-left btn-sm enDisBtn"  data-popup="tooltip" title="Duplo Clique para ativar" data-placement="left">
            ...
            <div class="modal-body">
                <form id="pcForm">
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Código de Compra</label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="pc"
                                placeholder="Digite o código de compra deste módulo" required id="pc">
                        </div>
                    </div>
