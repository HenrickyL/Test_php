...
@section("title") Editar Produtos - Painel
@endsection
@section('content')
            ...
            <div class="card-body">
                <form action="{{ route('admin.updateItem') }}" method="POST" enctype="multipart/form-data">
                    <legend class="font-weight-semibold text-uppercase font-size-sm">
                        <i class="icon-address-book mr-2"></i> Detalhes do produto
                    </legend>
                    ...
                    <div class="form-group row" style="display: none;" id="discountedTwoPrice">
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control form-control-lg price" name="old_price"
                                placeholder="Valor em {{ config('settings.currencyFormat') }}"
                                value="{{ $item->old_price }}">
                        </div>
                        <div class="col-lg-6">
                            <label class="col-form-label"><span class="text-danger">*</span>Valor com desconto:</label>
                            <input type="text" class="form-control form-control-lg price" name="price"
                                placeholder="Valor em {{ config('settings.currencyFormat') }}" id="newSP"
                                value="{{ $item->price }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row" id="singlePrice">
                        ...
                        <div class="col-lg-5">
                            <input type="text" class="form-control form-control-lg price" name="price"
                                placeholder="Valor em {{ config('settings.currencyFormat') }}" required id="oldSP"
                                value="{{ $item->price }}">
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label class="col-form-label">Valor: <i class="icon-question3 ml-1"
                                    data-popup="tooltip" title="Valor total do produto, nao deixe 0."
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Menu:</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <button class="btn btn-sm btn-danger badge badge-danger float-right" data-toggle="modal"
                                ...
                                style="font-size: 0.9rem;">Remover Todos
                            </button>
                                ...
                                <div class="modal-dialog modal-xs">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title"><span class="font-weight-bold">Voce tem certeza?</span>
                                            </h5>
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        </div>
                                        <div class="modal-body">
                                            <span class="help-text">Esta ação removerar todos os adicionais do produto..</span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="uploader">
                                ...
                                <span class="help-text text-muted">Tamanho: 486x355</span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">É Sugerido?</label>
                        <div class="col-lg-9">
