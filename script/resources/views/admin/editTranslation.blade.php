...
@section("title") Editar Tradução - Painel
@endsection
@section('content')
    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-circle-right2 mr-2"></i>
                <span class="font-weight-bold mr-2">Editar Idioma</span>
    ...
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <span class="help-text">Atenção!!! Essa mudança é permanente. <br> Você pode usar o "<strong>DESATIVAR</strong>" para desativar temporariamente a tradução.</span>
                <div class="modal-footer mt-4">
                    <a href="{{ route('admin.deleteTranslation', $translation_id) }}" class="btn btn-primary">Sim, deletar!</a>
