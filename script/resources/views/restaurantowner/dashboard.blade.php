...
<div class="content mb-5">
    ...
    <div class="row pt-4 p-0">
        ...
        <div class="col-xl-12">
            <div class="panel panel-flat dashboard-main-col mt-4">
                <div class="panel-heading">
                    <h4 class="panel-title pl-3 pt-3"><strong>{{__('storeDashboard.dashboardSelfPickup')}}</strong></h4>
                    <hr>
                </div>
                <div class="table-responsive">
        ...
        <div class="col-xl-12">
            <div class="panel panel-flat dashboard-main-col mt-4">
                <div class="panel-heading">
                    <h4 class="panel-title pl-3 pt-3"><strong>{{__('storeDashboard.dashboardOnGoingDelivery')}}</strong></h4>
                    <hr>
                </div>
