        ...
        <div class="card mb-0">
            <div class="card-body">
                <div class="text-center mb-3">
                    <center><img src="/assets/img/logos/logo.png"></center><br>
                    <h5 class="mb-0">Login no painel</h5>
                ...
                <div class="content d-flex justify-content-center align-items-center mt-3">
                    <button class="btn btn-lg btn-registerBtn mr-2 regButtonDelivery" type="button">Cadastrar Entregador</button>
                    <button class="btn btn-lg btn-registerBtn regButtonResOwn" type="button">Cadastrar Lojista</button>
                </div>
            </div>
        </div>
    </form>
        ...
        <div class="card mb-0">
            <div class="card-body">
                <div class="text-center mb-3">
                    ...
                    <h5 class="mb-0">Registro para <span id="regFor">Lojista</span></h5>
                    <span class="d-block text-muted">Preencha o formulário para se registrar</span>
                </div>
                <div class="form-group form-group-feedback form-group-feedback-left">
                ...
                {!! captcha_img('flat') !!}
                <div class="form-group form-group-feedback form-group-feedback-left">
                <input type="text" class="form-control" placeholder="Codigo" name="captcha" required="required">
                    <div class="form-control-feedback">
...
<div class="d-flex justify-content-center align-items-center mt-3">
     <div class="delivery-msg p-3"><b>SUCCESS!!!</b> Agora você pode fazer login no aplicativo de entrega usando seu telefone.</div>
</div>
@endif
@endsection