...
@section("title") Editar Paginas - Painel
@endsection
@section('content')
            ...
            <div class="card-body">
                <form action="{{ route('admin.updatePage') }}" method="POST" enctype="multipart/form-data">
                    <legend class="font-weight-semibold text-uppercase font-size-sm">
                        <i class="icon-address-book mr-2"></i> Detalhes
                    </legend>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control form-control-lg" name="name"
                                placeholder="Nome da pagina" required value="{{ $page->name }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control form-control-lg" name="slug"
                                placeholder="Nome do link" required value="{{ $page->slug }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><strong>Contexto:</strong></label>
                        <div class="col-lg-12">
    ...
    <div class="modal-dialog modal-xs">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Voce tem certeza?</span></h5>
