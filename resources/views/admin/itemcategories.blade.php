                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-flat border-grey-800 text-default text-capitalize">@if($itemCategory->is_enabled) Ativado @else Desativado @endif</span></td>
                            <td>
                            ...
                            <td class="text-center">
                                ...
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#editItemCategory" data-catid="{{ $itemCategory->id }}" data-catname="{{ $itemCategory->name }}"
                                        class="badge badge-primary badge-icon editItemCategory"> Editar <i class="icon-database-edit2 ml-1"></i></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Add menu</span></h5>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="name"
                                placeholder="Digite o nome do menu" required>
                        </div>
                    </div>
                    @csrf
            ...
            <div class="modal-body">
                <form action="{{ route('admin.updateItemCategory') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="name"
                                placeholder="Digite o nome do menu" required id="itemCatName">
                        </div>
                    </div>
                    @csrf
                    <div class="text-right">
