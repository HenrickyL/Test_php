                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified justify-content-center">
                                    ...
                                    <a href="{{ route('admin.makeDefaultLanguage', $translation->id) }}" class="badge badge-secondary badge-icon ml-1 @if($translation->is_default) badge-success @endif" data-popup="tooltip" title="Marcar {{ $translation->language_name }} como padrão" data-placement="bottom"> <i class="icon-checkmark4"></i> </a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
