...
@section("title") Categorias Adicionais - Painel
@endsection
@section('content')
    ...
    <form action="{{ route('admin.post.searchAddonCategories') }}" method="GET">
        <div class="form-group form-group-feedback form-group-feedback-right search-box">
            <input type="text" class="form-control form-control-lg search-input"
                placeholder="Procurar categoria pelo nome ..." name="query">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified">
                                    ...
                                    class="badge badge-primary badge-icon ml-1"> Ver Adicionais <i
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Add nova categoria</span></h5>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <select name="type" class="form-control form-control-lg">
                                <option value="SINGLE"> Seleção unica  </option>
                                <option value="MULTI"> Seleção multipla </option>
                            </select>
                        </div>
                    </div>
                    @csrf
